...
if (!VK.Share) {
    VK.Share = {
        ...
        button: function (gen, but, index) {
            ...
            var a = '<a href="' + this._base_domain + 'share.php?url=' + encodeURIComponent(gen.url) + '" onmouseup="this._btn=event.button;this.blur();" onclick="return VK.Share.click(' + index + ', this);"', a1 = a + ' style="text-decoration:none;">', a2 = '</a>', a3 = a + ' style="" class="btn btn-primary">', td1 = '<td style="vertical-align: middle;">', td2 = '</td>';
